...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_ortho_3x10(
    TD(TD_Q_TAB),   KC_W,               KC_E,           KC_R,  KC_T,               KC_Y,   KC_U,  KC_I,     KC_O,    TD(TD_P_BSPS),
    TD(TD_A_ESC),   LT(_SYMBOLS,KC_S),  KC_D,           KC_F,  KC_G,               KC_H,   KC_J,  KC_K,     KC_L,    LT(_ADJUST,KC_SPC), \
  ...
  [_NUMBERS] = LAYOUT_ortho_3x10(
    ...
    KC_F1,  KC_F2,  KC_F3,  KC_F4,   KC_F5,               KC_F6,    KC_HOME,  KC_PGDN,  KC_PGUP,  LT(_ADJUST,KC_SPC), \
...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_P_BSPS]  = ACTION_TAP_DANCE_DOUBLE(KC_P, KC_BSPC),
